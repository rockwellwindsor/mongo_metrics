...
class NavigationTest < ActionDispatch::IntegrationTest
  ...
  test "can visualize notifications" do
    get main_app.home_index_path
    get main_app.home_contact_path
    get main_app.home_about_path

    get mongo_metrics.root_path
    assert_match "Path: /home/about", response.body
    assert_match "Path: /home/contact", response.body
    assert_match "Path: /home/index", response.body
  end
